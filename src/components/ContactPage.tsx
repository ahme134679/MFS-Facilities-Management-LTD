      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          >
            ...
            <h3 className="text-4xl md:text-5xl font-bold text-mfs-navy mb-4">Ready to secure your business?</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-1 space-y-8">
            <motion.div 
              ...
              className="bg-slate-50 p-8 rounded-lg border border-gray-100 h-full"
            >
          ...
          <div className="lg:col-span-2">
            <motion.form 
              ...
              className="bg-white p-8 md:p-10 rounded-lg border border-gray-200 shadow-xl shadow-gray-200/40 relative overflow-hidden"
            >
